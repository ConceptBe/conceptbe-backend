...
public class MemberService {
    ...
    private List<BranchCategoryResponse> mapToMemberBranches(Member member) {
        IdeaNotificationSetting ideaNotificationSetting = notificationSettingRepository.findByMemberId(
                member.getId()
        );

        List<Branch> branches = ideaNotificationSetting.getBranches()
